/*Detta script är färdig kod hämtad ifrån internet för att utföra den önskade rättningsfunktionen, 
ni skall bara fokusera på att använda er av det färdiga scriptet på er hemsida.*/
